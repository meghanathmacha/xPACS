function [] = calculateDecisionSubs(subid,datafile,subsfile,trainid)
%% Reading subspace candiates from Part - 1
    ...
    [M,xc,n,status,rule] = ellipses3diag(A,B,C,l,r); 
    disp(xc);
    disp(subid);
    filerule = strcat('MFile',num2str(subid),'.csv');
    writerule(xc,M,status,l,r,n,densedims,filerule,rule,trainid);
